...
function handleTextElementBlur(event) {
...
function createItem(item) {
    ...
    duplicateButton.addEventListener("click", handleDuplicateButtonClick);
    editButton.addEventListener("click", handleEditButtonClick);
    textElement.addEventListener("blur", handleTextElementBlur);
